...
/**
 * Have to annotate always as injectable
 * because we have to inject services to components
 *
 * ----
 * This class also uses rxjs map and catch methods
 */
@Injectable()
export class SearchUsersService {
  ...
  getUsersByPlaceAndLanguage(place: string, language: string) {
    ...
    // use map and catch methods from rxjs
    // map - convert response to json object
